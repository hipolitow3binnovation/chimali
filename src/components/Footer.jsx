				...
				<div className="flex flex-col items-center justify-center w-full gap-8 pt-8 pb-24 md:w-1/2 ">
					...
					<div className="flex flex-col gap-10">
						<div className="flex flex-col gap-4 px-8 md:flex-row">
							<a href="mailto:contacto@chimalli.com" className="flex items-center gap-2 font-sans text-xs font-medium text-white uppercase">
								<ion-icon name="mail-outline"></ion-icon>
								<span>contacto@chimalli.com</span>
							</a>

							<a href="tel:961234008811" className="flex items-center gap-2 font-sans text-xs font-medium text-white uppercase">
